                            ...
                            <div class="row">
                                <table id="tabela" class="table table-hover table-bordered table-striped td-action">
                                    ...
                                    @foreach($complaints as $complaint)
                                        ...
                                        <tr>
                                            <td><a href='/admin/complaint/show/{{ $complaint->id }}'><span>{{ $complaint->name_2 }}</span></a></td>
                                            <td><a href='/admin/complaint/show/{{ $complaint->id }}'><span>{{ $complaint->name_1 }}</span></a></td>
