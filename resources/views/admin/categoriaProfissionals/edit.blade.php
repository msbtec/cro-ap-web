...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.categoriaProfissional.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.categoria-profissionals.update", [$categoriaProfissional->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
