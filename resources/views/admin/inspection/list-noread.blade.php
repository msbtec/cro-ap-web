            ...
            <div class="row">
                ...
                <div class="col-md-9" id="contato">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="m-0"><i class="fas fa-eye-slash"></i> E-mails não lidos </h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <table id="tabela" class="table table-hover table-bordered table-striped td-action">
                                    ...
                                    @foreach($inspections as $inspection)
                                        @php $created = with(new Carbon\Carbon($inspection->created_at))->diffForHumans() @endphp
                                        <tr>
                                            <td><a href='/admin/inspection/show/{{ $inspection->id }}'><span>{{ $inspection->name }}</span></a></td>
                                            <td><a href='/admin/inspection/show/{{ $inspection->id }}'><span>{{ $inspection->subject }}</span>{{  $inspection->message }}</a></td>
