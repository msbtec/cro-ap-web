                            ...
                            <div class="row">
                                <table id="tabela" class="table table-hover table-bordered table-striped td-action">
                                    ...
                                    @foreach($inspections as $inspection)
                                        ...
                                        <tr>
                                            <td><a href='/admin/inspection/show/trash/{{ $inspection->id }}'><span>{{ $inspection->name }}</span></a></td>
                                            <td><a href='/admin/inspection/show/trash/{{ $inspection->id }}'><span>{{ $inspection->subject }}</span>{{  $inspection->message }}</a></td>
