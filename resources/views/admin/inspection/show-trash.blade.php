            ...
            <div class="row">
                ...
                <div class="col-md-9" id="contato">
                    <div class="card card-danger card-outline">
                        <div class="card-header">
                            <h5 class="m-0"><i class="fas fa-book-reader"></i> Leitura - <span class="text-danger small">e-mail na lixeira</span> <span class="float-right"><a href="{{ route('admin.inspection.trash') }}" class="btn btn-primary btn-sm btn-flat"><i class="fas fa-hand-point-left"></i> Retornar</a> <a href="/admin/inspection/notrash/{{$inspection->id}}" class="btn btn-success btn-sm btn-flat text-white"><i class="fas fa-trash-restore"></i> Restaurar</a> <a href="{{ route('admin.inspection.destroy',$inspection->id) }}" class="btn btn-danger btn-sm btn-flat"><i class="fas fa-trash-alt"></i> Deletar definitivo</a></span></h5>
                        </div>
                        <div class="card-body">
