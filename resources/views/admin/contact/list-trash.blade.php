                            ...
                            <div class="row">
                                <table id="tabela" class="table table-hover table-bordered table-striped td-action">
                                    ...
                                    @foreach($contacts as $contact)
                                        ...
                                        <tr>
                                            <td><a href='/admin/contact/show/trash/{{ $contact->id }}'><span>{{ $contact->sender }}</span></a></td>
                                            <td><a href='/admin/contact/show/trash/{{ $contact->id }}'><span>{{ $contact->subject }}</span>{{  $contact->message }}</a></td>
