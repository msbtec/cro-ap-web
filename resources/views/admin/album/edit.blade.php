...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark"><i class="nav-icon fas fa-images"></i> Álbuns de foto</h5>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        {!! Form::model($album, array('method' => 'PUT','files' => true, 'route' => ['admin.album.update', $album->id])) !!}
                        <div class="card-body">
