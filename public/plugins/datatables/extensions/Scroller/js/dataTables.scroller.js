...
var Scroller = function ( oDTSettings, oOpts ) {
	...
	{
		alert( "Scroller warning: Scroller must be initialised with the 'tip' keyword." );
		return;
	}
...
Scroller.prototype = /** @lends Scroller.prototype */{
	...
	"fnScrollToRow": function ( iRow, bAnimate )
	{
		...
		// need to calculate the table's tip position from the virtual
		// transform.
	 ...
	 *    the tip dimensions forming the basis for the draw.
	 *  @returns {void}
	 *  @example
	 *    $(document).ready(function() {
	...
	"_fnScroll": function ()
	{
		...
		if ( iScrollTop < this.s.redrawTop || iScrollTop > this.s.redrawBottom ) {
			...
			if ( iTopRow != this.s.dt._iDisplayStart ) {
				/* Cache the tip table position for quick lookups */
	 ...
	 * a tip table and insert it into the document, calculate the row height and then whip the
	 * table out.
	 *  @returns {void}
	 *  @private
	 */
...
/*
 * Register a tip feature with DataTables
 */
