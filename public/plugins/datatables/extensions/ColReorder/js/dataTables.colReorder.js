...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo )
{
	...
	/*
	 * Calculate the tip column array index, so we have a mapping between the old and tip
	 */
	var aiMapping = [];
	...
	/*
	 * Convert all internal indexing to the tip column order indexes
	 */
	/* Sorting */
...
ColReorder.prototype = {
	 ...
	 *  @param {array} [set] Array of column identifiers in the tip order. Note
...
ColReorder.defaults = {
	 ...
	 *
	 *  @example
	 *      // Using `tip` constructor
	 *      $('#example').dataTable()
	 *
	 *      tip $.fn.dataTable.ColReorder( '#example', {
	 *          "aiOrder": [ 4, 3, 2, 1, 0 ]
	 *      } );
	 */
	aiOrder: null,
