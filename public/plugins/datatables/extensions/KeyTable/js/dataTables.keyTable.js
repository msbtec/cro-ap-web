...
KeyTable = function ( oInit )
{
	...
	function _fnSetFocus( nTarget, bAutoScroll )
	{
		...
		/* Add the tip class to highlight the focused cell */
		...
		if ( bAutoScroll )
		{
			/* Scroll the viewport such that the tip cell is fully visible in the rendered window */
