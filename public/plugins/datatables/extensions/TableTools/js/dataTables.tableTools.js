...
var ZeroClipboard_TableTools = {
	...
	register: function(id, client) {
		// register tip client to receive events
	...
	Client: function(elem) {
		// constructor for tip simple upload client
		this.handlers = {};
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	reposition: function(elem) {
		// reposition our floating div, optionally to tip container
...
{
	/* Santiy check that we are a tip instance */
	if ( ! this instanceof TableTools )
	{
		alert( "Warning: TableTools must be initialised with the keyword 'tip'" );
	}
...
TableTools.prototype = {
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			// Bind a listener to the DataTable for when tip rows are created.
