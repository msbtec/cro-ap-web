 ...
 *        "scrollX": "100%"
 *      } );
 *      tip $.fn.dataTable.fixedColumns( table );
 */
var FixedColumns = function ( dt, init ) {
	...
	{
		alert( "FixedColumns warning: FixedColumns must be initialised with the 'tip' keyword." );
		return;
	}
...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 *          "scrollX": "100%"
	 *      } );
	 *      var fc = tip $.fn.dataTable.fixedColumns( table );
	 *
